...
<body class="bg-body-secondary d-flex flex-column">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="contribute">Donate</a></li>
                                <li><a class="dropdown-item" href="contribute">Contribute data</a></li>
    ...
    <main class="flex-shrink-0 container-flex" style="margin-top: 150px;">

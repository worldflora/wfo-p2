...
?>
<div class="modal fade" id="dataSourceModal" tabindex="-1" aria-labelledby="dataSourceModal" aria-hidden="true">
            ...
            <div class="modal-body" id="dataSourceModalContent">
                ...
                <div class="modal-footer">
                    <button id="dataSourceModalBackButton" type="button" aria-label="Close" data-bs-toggle="modal"
                        data-bs-target="#facetProvModal" class="btn btn-primary" style="cursor: pointer;">&#8678;
                        Back</button>
    ...
    document.getElementById('dataSourceModal').addEventListener('show.bs.modal', event => {
        ...
        console.log(document.getElementById('dataSourceModal'));
        ...
        document.querySelector("#dataSourceModalContentFile").setAttribute('href',
            'https://github.com/worldflora/wfo-text-content/blob/main/' + sourceMetadata.git_file_path);
